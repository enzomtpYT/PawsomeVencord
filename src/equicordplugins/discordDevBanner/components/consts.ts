...
export const settingVariables = [
    ...
    "",
    "PawsomeVencord Variables:",
    "{equicordIcon} - PawsomeVencord icon",
    "{equicordVersion} - Version of PawsomeVencord (e.g. 1.0.0)",
    "{equicordHash} - PawsomeVencord build hash (e.g. 123456789)",
    "{equicordPlatform} - Platform PawsomeVencord is running on (e.g. Dev Build)",
    "",
    "Pawtop Specific Variables:",
    "{equibopHash} - Pawtop build hash (e.g. 123456789)",
    "{equibopPlatform} - Platform Pawtop is running on (e.g. Dev Build)",
    "",
    "Client Variables:",
