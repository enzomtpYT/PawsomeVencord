...
export function initStyles() {
    ...
    const vesktopCssNode = (IS_VESKTOP || IS_PAWTOP) ? createAndAppendStyle("vesktop-css-core", coreStyleRootNode) : null;
    ...
    if (IS_VESKTOP && VesktopNative.app.getRendererCss || IS_PAWTOP && VesktopNative.app.getRendererCss) {
