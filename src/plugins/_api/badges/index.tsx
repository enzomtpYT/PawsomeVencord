...
import { EquicordDonorModal, EquicordTranslatorModal, PawsomeDonorModal, VencordDonorModal } from "./modals";
...
export default definePlugin({
    ...
    getPawsomeDonorBadges(userId: string) {
        return PawsomeDonorBadges[userId]?.map((badge, idx) => ({
            id: `pawsome_donor_badge_${idx}`,
            iconSrc: badge.badge,
            description: badge.tooltip,
            position: BadgePosition.START,
            props: {
