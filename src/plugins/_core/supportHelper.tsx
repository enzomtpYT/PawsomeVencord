        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (!IS_WEB && IS_UPDATER_DISABLED) {
                openModal(props => (
                    ...
                    >
                        <div>
                            <Paragraph>You are using an externally updated PawsomeVencord version, which we do not provide support for!</Paragraph>
                            <Paragraph className={Margins.top8}>
                                Please either switch to an <Link href="https://github.com/enzomtpYT/PawsomeVencord/releases">officially supported version of PawsomeVencord</Link>, or
