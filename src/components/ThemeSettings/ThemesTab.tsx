...
export function CspErrorCard() {
    ...
    return (
        <ErrorCard className="vc-settings-card">
            ...
            <Paragraph>
                After allowing a domain, you have to fully close (from tray / task manager) and restart {IS_DISCORD_DESKTOP ? "Discord" : IS_PAWTOP ? "Pawtop" : "Vesktop"} to apply the change.
            </Paragraph>
