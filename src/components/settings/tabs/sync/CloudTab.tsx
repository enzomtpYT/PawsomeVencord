    ...
    return (
        <SettingsTab>
            ...
            <Notice.Info className={Margins.bottom16}>
                We use <Link href="https://github.com/Equicord/Equicloud">Equicloud backend</Link> with enhanced features.
                View equicord's <Link href="https://equicord.org/cloud/policy">privacy policy</Link> to see what they store and how they use your data.
            ...
            <Paragraph className={Margins.bottom16}>
                Synchronize your PawsomeVencord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.
            </Paragraph>
