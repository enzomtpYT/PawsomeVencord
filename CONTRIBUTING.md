...
## Improving PawsomeVencord Itself

If you want to improve PawsomeVencord beyond plugins, such as internal features or performance improvements, you are welcome to open a feature request so it can be discussed.
